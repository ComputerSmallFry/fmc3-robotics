...
# =====================================================================
# Action 37维 → GR2Robot 关节组映射
# =====================================================================
#  0-6:   左臂    7-13:  右臂
# 14-19:  左手   20-25:  右手
# 26-27:  头部   28-30:  腰部   31-36: 基座速度
...
BASE_VEL_SLICE = slice(31, 37)

# Action 中手指顺序: [pinky, ring, middle, index, thumb_pitch, thumb_yaw]
# SDK 期望的顺序:    [index, middle, ring, pinky, thumb_pitch, thumb_yaw]
HAND_ACTION_TO_SDK = [3, 2, 1, 0, 4, 5]
...
class GR2PolicyDeployer:
    ...
    def get_robot_state(self) -> np.ndarray:
        ...
        group_map = {
            ...
            "head":              slice(14, 16),
            "waist":             slice(16, 17),
            "left_hand":         slice(17, 23),
            "right_hand":        slice(23, 29),
        }
    ...
    def action_to_robot_command(self, action: np.ndarray):
        ...
        for group_name, s in ACTION_SLICES.items():
            ...
            if group_name in ("left_hand", "right_hand"):
                vals = vals[HAND_ACTION_TO_SDK]
            joint_targets[group_name] = vals.tolist()
